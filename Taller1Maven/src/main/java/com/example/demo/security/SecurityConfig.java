...
//		httpSecurity.authorizeRequests().antMatchers("/**").authenticated().and().authorizeRequests()
//				.antMatchers("/apps/admin/**").hasAnyRole(UserType.admin.toString() + "," + UserType.doctor.toString())
//				.and().authorizeRequests().antMatchers("/users/**").hasRole(UserType.admin.toString()).and().formLogin()
